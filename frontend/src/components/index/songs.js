...
class SongsIndex extends React.Component {
  ...
  render() {
    ...
    liSongs = Object.values(songs).map(song => <SongIndexItem key={song.id} song={song} playTrack={this.props.playTrack} addSongToPlaylist={this.props.addSongToPlaylist} />);

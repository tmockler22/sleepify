...
class ArtistShow extends React.Component {
  ...
  render() {
    ...
    if (songs) {
      liSongs = songs.map(song => <SongIndexItem key={song.id} song={song} addTrack={this.props.addTrack} playTrack={this.props.playTrack} addSongToPlaylist={this.props.addSongToPlaylist} openModal={this.props.openModal} closeModal={this.props.closeModal}/>); 
    }
    return (
